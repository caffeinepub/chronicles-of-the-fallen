...
export class Backend implements backendInterface {
    ...
    async getAllPlayerProgress(): Promise<Array<PlayerProgress>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPlayerProgress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReachedEndings(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReachedEndings();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isProgressSaved(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isProgressSaved();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProgress(arg0: PlayerProgress): Promise<void> {
        if (this.processError) {
            try {
